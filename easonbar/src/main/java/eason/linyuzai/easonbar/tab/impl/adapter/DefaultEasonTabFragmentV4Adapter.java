...
public class DefaultEasonTabFragmentV4Adapter<F extends Fragment> implements EasonTabFragmentAdapter<F> {

    private FragmentManager fragmentManager;
    private int frameLayoutId;

    public DefaultEasonTabFragmentV4Adapter(FragmentManager fragmentManager, int frameLayoutId) {
